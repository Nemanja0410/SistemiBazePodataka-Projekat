...
namespace OsiguranjApp
{
    public partial class DTOManager
    {
        ...
        public static void azurirajFizickoLice(FizickoLicePregled dto)
        {
            ProveriOvlascenje("ADMIN", "AGENT");
            try
            {
                ISession s = DataLayer.GetSession();
                FizickoLice fl = s.Load<FizickoLice>(dto.KlijentId);
                fl.Naziv = dto.Naziv; fl.Adresa = dto.Adresa;
                fl.Telefon = dto.Telefon; fl.Email = dto.Email; fl.Status = dto.Status;
                fl.Jmbg = dto.Jmbg; fl.DatumRodjenja = dto.DatumRodjenja; fl.Zanimanje = dto.Zanimanje;
                s.SaveOrUpdate(fl);
                s.Flush();
                s.Close();
            }
        ...
        public static void azurirajPravnoLice(PravnoLicePregled dto)
        {
            ProveriOvlascenje("ADMIN", "AGENT");
            try
            {
                ISession s = DataLayer.GetSession();
                PravnoLice pl = s.Load<PravnoLice>(dto.KlijentId);
                pl.Naziv = dto.Naziv; pl.Adresa = dto.Adresa;
                pl.Telefon = dto.Telefon; pl.Email = dto.Email; pl.Status = dto.Status;
                pl.Pib = dto.Pib; pl.MaticniBroj = dto.MaticniBroj; pl.Delatnost = dto.Delatnost;
                s.SaveOrUpdate(pl);
                s.Flush();
                s.Close();
            }
        ...
        public static void azurirajJavnuInstituciju(JavnaInstitucijaPregled dto)
        {
            ProveriOvlascenje("ADMIN", "AGENT");
            try
            {
                ISession s = DataLayer.GetSession();
                JavnaInstitucija ji = s.Load<JavnaInstitucija>(dto.KlijentId);
                ji.Naziv = dto.Naziv; ji.Adresa = dto.Adresa;
                ji.Telefon = dto.Telefon; ji.Email = dto.Email; ji.Status = dto.Status;
                ji.Pib = dto.Pib; ji.MaticniBroj = dto.MaticniBroj;
                ji.Delatnost = dto.Delatnost; ji.NivoInstitucije = dto.NivoInstitucije;
                s.SaveOrUpdate(ji);
                s.Flush();
                s.Close();
            }
