...
{
    partial class DodajPolisaForma
    {
        ...
        // Kontrole tip-specificnih polja - popunjavaju se dinamicki, po jedan skup po tipu.
        ...
        // Pending liste - upisuju se u bazu tek posle uspesnog kreiranja polise (kad se zna PolisaId).
        private readonly List<UlogaKlijentaBasic> _pendingOsiguranici = new();
        private readonly List<DodatnoPokrBasic> _pendingPokrica = new();
        private readonly List<KorisnikIsplateBasic> _pendingKorisnici = new();
        private ListBox lstPendingOsiguranici = null!, lstPendingPokrica = null!, lstPendingKorisnici = null!;
        ...
        private void InitializeComponent()
        {
            ...
            pnlTipSpecificno = new Panel { Width = 500, AutoSize = true, MinimumSize = new Size(500, 0) };
